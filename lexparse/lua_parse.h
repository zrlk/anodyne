...
class Block : public Node {
 public:
  ...
  Block(const yy::location &location, Tuple *stmts,
...
class While : public Node {
 public:
  While(const yy::location &location, Node *condition, Node *block)
...
class ElseIf : public Node {
 public:
  ElseIf(const yy::location &location, Node *exp, Node *block)
...
class Function : public Node {
 public:
  Function(const yy::location &location, Tuple *bindings, bool varargs,
           Node *body)
...
class FunctionBinding : public Node {
 public:
  ...
  FunctionBinding(const yy::location &location, Symbol local_name, Node *body)
      : Node(location), kind_(Kind::Local), symbol_(local_name), body_(body) {}
  FunctionBinding(const yy::location &location, Tuple *path, Node *body)
      : Node(location), kind_(Kind::Global), path_(path), body_(body) {}
  FunctionBinding(const yy::location &location, Tuple *path, Symbol member,
                  Node *body)
      : Node(location),
...
class VarBinding : public Node {
 public:
  VarBinding(const yy::location &location, bool local, Tuple *vars,
             Tuple *inits)
...
class If : public Node {
 public:
  If(const yy::location &location, Node *exp, Node *then, Tuple *elseives,
     Node *elze)
      : Node(location),
        exp_(exp),
        elseives_(elseives),
...
class Tuple : public Node {
 public:
  ...
  Tuple(const yy::location &location, size_t element_count, Node **elements)
...
class Call : public Node {
 public:
  Call(const yy::location &location, Node *function, Tuple *args)
...
class Var : public Node {
 public:
  Var(const yy::location &location, Symbol symbol)
...
class Literal : public Node {
 public:
  ...
  Literal(const yy::location &location, Type type)
      : Node(location), type_(type) {}
  Literal(const yy::location &location, Type type, Symbol symbol)
...
class ArgsReference : public Node {
 public:
  explicit ArgsReference(const yy::location &location) : Node(location) {}
...
class Index : public Node {
 public:
  Index(const yy::location &location, Node *lhs, Node *subscript)
...
class DirectIndex : public Node {
 public:
  DirectIndex(const yy::location &location, Node *lhs, Symbol subscript)
      : Node(location), lhs_(lhs), subscript_(subscript) {}
...
class UnaryOp : public Node {
 public:
  ...
  UnaryOp(const yy::location &location, Op op, Node *operand)
...
class BinaryOp : public Node {
 public:
  ...
  BinaryOp(const yy::location &location, Op op, Node *lhs, Node *rhs)
...
class TableConstructor : public Node {
 public:
  TableConstructor(const yy::location &location, Tuple *fields)
...
class Field : public Node {
 public:
  ...
  Field(const yy::location &location, Node *exp)
      : Node(location), kind_(Kind::Exp), exp_(exp) {}
  Field(const yy::location &location, Symbol symbol, Node *exp)
      : Node(location), kind_(Kind::Label), exp_(exp), symbol_(symbol) {}
  Field(const yy::location &location, Node *index, Node *exp)
